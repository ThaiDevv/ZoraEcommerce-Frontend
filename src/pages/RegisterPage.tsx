  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center min-h-[calc(100vh-4rem)] py-10 sm:py-14 lg:py-16 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-5xl bg-white/95 backdrop-blur-xl rounded-3xl shadow-[0_25px_70px_-15px_rgba(15,23,42,0.08),0_10px_30px_-10px_rgba(238,77,45,0.08),0_0_0_1px_rgba(255,255,255,0.9)] border border-slate-200/70 overflow-hidden grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="relative z-10 my-auto py-2">
              ...
              <div className="mb-4 text-left">
                <h2 className="text-2xl font-bold text-[#0F172A] tracking-tight font-['Plus_Jakarta_Sans'] leading-snug">
                  Mua sắm <span className="italic font-serif font-normal text-[#ee4d2d] text-[1.12em]">tiện lợi</span>
                ...
                <p className="text-xs text-slate-500 font-light mt-1.5 leading-relaxed">
                  Tạo tài khoản ZoraEcommerce để săn ngàn ưu đãi hấp dẫn, tích xu và theo dõi đơn hàng tiện lợi.
                </p>
              </div>
              ...
              >
                ...
                >
                  ...
                  <img
                    src="/images/register-art.jpg?v=5"
                    alt="Hộp kiện hàng ZoraEcommerce"
                ...
                {/* Floating Micro-Badge Pill */}
                <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-md px-3 py-1 rounded-full shadow-md border border-slate-200/80 flex items-center gap-1.5 whitespace-nowrap z-20">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#ee4d2d] animate-ping" />
                  <span className="text-[10px] font-semibold text-[#0F172A] font-['Plus_Jakarta_Sans']">
                    Zora<span className="text-[#ee4d2d]">Ecommerce</span> · 2026
                  </span>
                </div>
